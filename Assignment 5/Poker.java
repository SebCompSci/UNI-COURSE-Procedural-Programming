...
class Poker{
    ...
    public String[] discard_cards(String[] initialCards, String[] cardsToDiscard) {
        ...
        if(cardsToDiscard.length > 0) {
            ArrayList<String> cardsList = ArrayManipulation.Array2ArrayList(initialCards);
            ArrayList<String> discardList = ArrayManipulation.Array2ArrayList(cardsToDiscard);
            for(int i = 0; i < initialCards.length; i++) {
                if(cardsList.get(i) == discardList.get(0)) {
                    cardsList.remove(i);
                    break;
                }
            }
            ...
            return discard_cards(ArrayManipulation.ArrayList2Array(cardsList), ArrayManipulation.ArrayList2Array(discardList));
        }
